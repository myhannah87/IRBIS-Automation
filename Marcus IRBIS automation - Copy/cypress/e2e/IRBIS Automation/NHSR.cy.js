...
describe('NHSR', () => {
    ...
    // beforeEach (() => {
        ...
        //cy.visit('https://orisdev.research.unc.edu/irb_maint/eform_routing.cfm?masterid=382905');
         //cy.visit('https://orisdev.research.unc.edu/irb_maint/eform_screens.cfm?MasterId=382917&ScreenId=2');
...
// A.9 IDENTIFIERS
        ...
        cy.get('#tbl_69_792 > tbody > :nth-child(1) > td.copy > [style="position: relative; display: block;"] > div > .copy').click()
        cy.get('[qid="h_811"] > [width="99%"]').should("be.visible")
        cy.get('#tbl_69_811 > tbody > :nth-child(1) > td.copy > [style="position: relative; display: block;"] > div > .copy').click()
...
// NHSR ACTIVITIES
        ...
        cy.get('[style="border: solid 1px #e1e1e1; width: 98%;"] > :nth-child(2) > .copy').click()
        cy.get('[qid="h_562"] > [width="99%"]').should("be.visible")
        cy.get('[style="border: solid 1px #e1e1e1; width: 98%;"] > :nth-child(11) > .copy').click()
...
// ATTACHMENTS
        ...
        cy.get('#modalPopup').should("be.visible") 
        cy.get('.proceedForm > :nth-child(1)').should("be.visible") 
...
//});
    ...
    //})
        ...
        cy.get('td[data-title="Submitted To IRB"] > .bucket > :nth-child(2) > table > tbody > :nth-child(6) > .countTotal > a').click()
        cy.wait(1000)
        cy.get('#bucketDataTable_filter > label > input').type('My NHSR Cypress Test')
      ...
      //  cy.url().then((url) => {
        ...
        cy.get('input#password.long')
          .type('test{Enter}')     
        cy.get('td[data-title="Accepted By IRB"] > .bucket > :nth-child(2) > table > tbody > :nth-child(5) > .countTotal > a').click()
        cy.wait(1000)
        cy.get('#bucketDataTable_filter > label > input').type('My NHSR Cypress Test')
        ...
        cy.get('td[data-title="PI Responses"] > .bucket > :nth-child(2) > table > tbody > :nth-child(6) > .countTotal > a').click()
        cy.wait(1000)
        cy.get('#bucketDataTable_filter > label > input').type('My NHSR Cypress Test')
        cy.get('#bucketDataTable > tbody > .odd > :nth-child(1) > a').click()
        cy.wait(3000)
 ...
 */
  ...
  //Draft Letter 
   ...
   cy.get('#btnDraftLetter').click()  
   cy.get('#btnFinalizeLetterModal').click()
   cy.get('[aria-labelledby="ui-dialog-title-2"] > .ui-dialog-buttonpane > .ui-dialog-buttonset > .btn-info').click()
