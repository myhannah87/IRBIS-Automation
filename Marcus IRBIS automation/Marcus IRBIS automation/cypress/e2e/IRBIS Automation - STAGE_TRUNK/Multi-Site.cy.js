describe("Login", () => {
  it("Create Multi-Site", () => {
    ...
    //cy.visit('https://orisstage.research.unc.edu/irb/eform_screens.cfm?MasterId=383070&ScreenId=2');
    ...
    cy.get("#q_29_3").should("be.visible").type("My Multi-Site Cypress Test");

    cy.get("#cke_q_29_554")
      .should("be.visible")
      .type("My Multi-Site Cypress Test");
    ...
    cy.log("printing the id").then(function () {
      ...
      cy.get('[qid="q_6"] > .copy > #q_2_6').type("Steve");
      cy.get('[qid="q_11"] > .copy > #q_2_11').type("123456");
      cy.get('[qid="q_14"] > .copy > #q_2_14').type("saustin@gmail.com");
      cy.get('[qid="q_2142"] > .copy > #q_2_2142').type("The Ohio State", {
        force: true,
      });
      cy.get(
        '[qid="q_15"] > td.copy > [inputvalue="External Site PI"] > #q_2_15'
      ).click();
   ...
   cy.visit('https://orisstage.research.unc.edu/irb/eform_lku.cfm?&lku=personnel&ref=eform&que=4&FRM=@masterId');
   cy.get('.tableheadersub3 > a').click()
  */

      /*cy.url().as('AddExternalsURL')
   cy.log(`Routing link is: ${this.AddExternalsURL}`) 
  });*/
    });
    ...
    cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      ...
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.1.1 TEST");
    });

    cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.1.2 TEST");
    });
    ...
    cy.get("iframe.cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.1.3 TEST");
    });
    ...
    cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.1.6 TEST");
    });
    ...
    cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.A.1 TEST");
    });
    ...
    cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.A.2 TEST");
    });
    ...
    cy.get("#cke_3_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.A.3 TEST");
    });
    ...
    cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.B.1 TEST");
    });
    ...
    cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.B.2 TEST");
    });
    ...
    cy.get("#cke_3_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.B.3 TEST");
    });
    ...
    cy.get("#cke_4_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.B.4 TEST");
    });
    ...
    cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.C.1 TEST");
    });
    ...
    cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.C.2 TEST");
    });
    ...
    cy.get("#cke_3_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.C.3 TEST");
    });
    ...
    cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.D.1 TEST");
    });
    ...
    cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.D.2 TEST");
    });
    ...
    cy.get("#cke_3_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.D.3 TEST");
    });
    ...
    cy.get("#cke_4_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.D.4 TEST");
    });
    ...
    cy.get("#cke_5_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.D.5 TEST");
    });
    ...
    cy.get("#cke_6_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.D.6 TEST");
    });
    ...
    cy.get("#cke_7_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.D.7 TEST");
    });
    ...
    cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.E.1 TEST");
    });
    ...
    cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.E.2 TEST");
    });
    ...
    cy.get("#cke_3_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.E.3 TEST");
    });
    ...
    cy.get("#cke_4_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.E.4 TEST");
    });
    ...
    cy.get(".cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.2.F.1 TEST");
    });
    ...
    cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.3.1 TEST");
    });
    ...
    cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.3.2 TEST");
    });
    ...
    cy.get("#cke_3_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS A.3.3 TEST");
    });
    ...
    cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.4.2");
    });
    ...
    cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.4.3");
    });
    ...
    cy.get("#cke_3_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.4.4");
    });
    ...
    cy.get("#cke_4_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.4.5");
    });
    ...
    cy.get("#cke_5_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.4.7");
    });
    ...
    cy.get("#cke_6_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.4.8");
    });
    ...
    cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
      const $body = $iframe.contents().find("body");
      console.log($body);
      cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.4.A.1");
    });
  });
  ...
  cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.4.A.2");
  });
  ...
  cy.get('#hd_1298\\|\\|Yes\\ Investigator\\ Initiated > [width="99%"]').should(
    "be.visible"
  );
  cy.get('[qid="h_1299"] > [width="99%"]').should("be.visible");
  ...
  cy.get('#hd_1304\\|\\|Yes\\,Waived\\,Exempt\\,NoFDA > [width="99%"]').should(
    "be.visible"
  );
  cy.get(
  ...
  cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.5.1");
  });
  ...
  cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.5.2");
  });
  ...
  cy.get("#cke_3_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.5.3");
  });
  ...
  cy.get("#cke_7_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.6.12");
  });
  ...
  cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.7.1");
  });
  ...
  cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.7.2");
  });
  ...
  cy.get("#cke_3_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.7.3");
  });
  ...
  cy.get("#cke_4_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.7.4");
  });
  ...
  cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.8.1");
  });
  ...
  cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.8.2");
  });
  ...
  cy.get("#cke_3_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.8.3");
  });
  ...
  cy.get("#cke_4_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.8.4");
  });
  ...
  cy.get(".cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.9.3");
  });
  ...
  cy.wait(1000);
  cy.get('[qid="h_814"] > [width="99%"]').should("be.visible");
  cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.10.1");
  });
  ...
  cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.10.2");
  });
  ...
  cy.get("#cke_3_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.10.3");
  });
  ...
  cy.get("#cke_4_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.10.5");
  });
  ...
  cy.get("#cke_5_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.10.6");
  });
  ...
  cy.get(".cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.11.2");
  });
  ...
  cy.get(".cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST A.12.1");
  });
  ...
  cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST B.1.3");
  });
  ...
  cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST B.1.5");
  });
  ...
  cy.get("#cke_3_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST B.1.6");
  });
  ...
  cy.get("#cke_4_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST B.1.7");
  });
  ...
  cy.get("#cke_5_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST B.1.8");
  });
  ...
  cy.get("#cke_6_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST B.1.9");
  });
  ...
  cy.get("#cke_7_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST B.1.10");
  });
  ...
  cy.get("#cke_8_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST B.1.11");
  });
  ...
  cy.get("#q_79_957").type(
    "My Multi-Site IRB B.2.1 test - List the data you are planning to collect for this purpose."
  );
  cy.get("#tbl_79_956 > tbody > :nth-child(2) > td.copy").should("be.visible");
  cy.get("#q_79_958").type(
    "My Multi-Site B.2.1 test - Describe how confidentiality/privacy will be protected prior to ascertaining the patients willingness to participate"
  );
  cy.get("#tbl_79_956 > tbody > :nth-child(3) > td.copy").should("be.visible");
  cy.get("#q_79_959").type(
    "My Multi-Site B.2.1 test - Describe when and how you will destroy PHI for individuals"
  );
  cy.get(":nth-child(4) > td.copy").should("be.visible");
  cy.get("#q_79_2293").type(
    "My Multi-Site B.2.1 test - Please explain how screening could not be practicably conducted without the waiver."
  );
  cy.get(":nth-child(5) > td.copy").should("be.visible");
  cy.get("#q_79_2294").type(
    "My Multi-Site B.2.1 test - Explain why it would not be possible to conduct the screening without the use of PHI"
  );
  ...
  cy.get("#q_80_970").type("My Multi-Site test B.3.1");
  cy.get('[qid="h_971"] > [width="99%"]').should("be.visible");
  cy.get("#q_80_971").type("My Multi-Site test B.3.2");
  cy.get('[qid="h_972"] > [width="99%"]').should("be.visible");
  cy.get("#q_80_972").type("My Multi-Site test B.3.3");
  ...
  cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST B.3.5");
  });
  ...
  cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST B.3.6");
  });
  ...
  cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST B.4.1.A");
  });
  ...
  cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST B.4.1.B");
  });
  ...
  cy.get("#cke_3_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST B.4.1.C");
  });
  ...
  cy.get("#cke_4_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST B.4.1.D");
  });
  ...
  cy.get("#cke_5_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST B.4.1.E");
  });
  ...
  cy.get(".cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST C.1.2");
  });
  ...
  cy.get(".cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST C.2.1");
  });
  ...
  cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST D.1.1");
  });
  ...
  cy.get("#q_75_906").type("My Multi-Site CYPRESS TEST D.1.1");
  ...
  cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST D.1.2");
  });
  ...
  cy.get("#cke_3_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST D.1.3");
  });
  ...
  cy.get("#cke_4_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST D.1.4");
  });
  ...
  cy.get("#cke_5_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST D.1.5");
  });
  ...
  cy.get("#cke_6_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST D.1.6");
  });
  ...
  cy.get(".cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST D.2.1");
  });
  ...
  cy.get("#cke_1_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST D.3.1");
  });
  ...
  cy.get("#cke_2_contents > .cke_wysiwyg_frame").then(function ($iframe) {
    const $body = $iframe.contents().find("body");
    console.log($body);
    cy.wrap($body[0]).type("My Multi-Site CYPRESS TEST D.3.2");
  });
