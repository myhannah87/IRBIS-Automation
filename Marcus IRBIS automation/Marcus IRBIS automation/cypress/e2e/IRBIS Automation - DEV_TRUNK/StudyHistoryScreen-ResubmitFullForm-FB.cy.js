describe('', () => {
  beforeEach (() => {
   //  cy.visit('https://orisdev.research.unc.edu/irb/index.cfm?event=admin.reviewWindow&reviewId=530805&appId=416288');
     cy.visit('https://orisdev.research.unc.edu/irb/index.cfm?event=admin.study.pgStudy&irbid=22-3322');
 ...
 // cy.visit(`https://orisdev.research.unc.edu/irb/index.cfm?event=admin.reviewWindow&reviewId=@InitialReviewId`);
    //console.log(InitialReviewId); //-> this returns the ID I need!
    //cy.get('#bucketFinderText').type(InitialAppId) 
   //cy.visit('https://orisdev.research.unc.edu/irb/index.cfm?event=admin.reviewWindow&reviewId=@InitialReviewId&appId=@InitialAppId');
