describe("JIT/118", () => {
  ...
  it("Create JIT/118", () => {
    ...
    cy.get(
      '[qid="q_2257"] > td.copy > [style="position: relative; display: block;"] > div > .copy'
    ).click();
    cy.get(
      '[qid="q_2258"] > td.copy > [style="position: relative; display: block;"] > :nth-child(2) > .copy'
    ).click();
    ...
    cy.get("#q_29_3").should("be.visible").type("My JIT/118 Cypress Test"); //.should('have.value', 'My JIT Regression Test')
    ...
    cy.get('[qid="q_1204"] > .copy > #q_98_1204').select("Federal");
    cy.get(
  ...
  it("JIT/118 Being Routed", () => {
    ...
    cy.get('input[placeholder="Title"]').type("My JIT/118 Cypress Test");
  ...
  it("Verify Application/Review popup", () => {
    ...
    cy.get(":nth-child(2) > .macrosContainer > .insertmacro")
      .should("contain", "Add Macro")
      .select("DOJ");
    ...
    cy.get(":nth-child(3) > .macrosContainer > .insertmacro")
      .should("contain", "Add Macro")
