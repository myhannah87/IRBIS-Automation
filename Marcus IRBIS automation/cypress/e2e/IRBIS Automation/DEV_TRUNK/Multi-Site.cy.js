describe('Login', () => {
  beforeEach (() => {
    ...
    //cy.visit('https://orisdev.research.unc.edu/irb/eform_screens.cfm?MasterId=383070&ScreenId=2');
    //cy.get('title')
      //  .invoke('text')
        //.should('equal', '\nIRB \n') 
...
/*
   ...
   cy.visit('https://orisdev.research.unc.edu/irb/eform_lku.cfm?&lku=personnel&ref=eform&que=4&FRM=@masterId');
