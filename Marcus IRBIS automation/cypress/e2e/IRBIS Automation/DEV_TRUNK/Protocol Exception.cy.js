describe('Protocol Exception',  () => {
 it('Create Protocol Exception', () => {
  ...
  //cy.visit('https://orisdev.research.unc.edu/irb/index.cfm?event=home.dashboard.irbStudyManagement&irb_id=22-2824');
 ...
 it('Protocol Exception - Being Routed/PI Cert', () => {
  ...
  //cy.visit('https://orisdev.research.unc.edu/irb/index.cfm?event=home.protocolException&id=383967');
  cy.get('input#username.long')
...
it('Protocol Exceptions - Waiting PI Response', () => {
  ...
  //cy.visit('https://orisdev.research.unc.edu/irb/index.cfm?event=home.protocolException&id=383860');
  cy.get('input#username.long')
          .type('mchopra').should('have.value', 'mchopra')  
  cy.get('input#password.long')
          .type('test{Enter}') 
...
it.only('Protocol Exceptions - Verify Resubmitted Review popup', () => {
  cy.visit('https://orisdev.research.unc.edu/irb/index.cfm?event=general.logout');
  //cy.visit('https://orisdev.research.unc.edu/irb/index.cfm?event=admin.reviewWindow.PIResponses&masterId=383860&previousReviewId=285764&reviewId=531421&appId=416692');
  //cy.visit('https://orisdev.research.unc.edu/irb/index.cfm?event=admin.reviewWindow&reviewId=531421&appId=416692');
