    describe('NHSR',  () => {
       it('Create NHSR Application', () => {
        ...
        //cy.visit('https://orisdev.research.unc.edu/irb/eform_routing.cfm?masterid=382905');
        //cy.visit('https://orisdev.research.unc.edu/irb/eform_screens.cfm?MasterId=382917&ScreenId=2');
...
// ATTACHMENTS
 ...
 //NHSR ROUTING  
        ...
        cy.visit('https://orisdev.research.unc.edu/irb/index.cfm?event=home.dashboard');
        cy.get('input#username.long')
...
it('Verify Application/Review popup', () => {
        cy.viewport(1400, 850) 
        cy.visit('https://orisdev.research.unc.edu/irb/index.cfm?event=general.logout');
        //cy.visit('https://orisdev.research.unc.edu/irb/index.cfm?event=admin.reviewWindow&reviewId=531057&appId=416502');
        cy.get('input#username.long')
