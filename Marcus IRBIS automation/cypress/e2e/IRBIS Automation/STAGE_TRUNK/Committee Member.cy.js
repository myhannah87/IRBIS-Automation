...
describe('Login as Committee Member', () => {
  ...
  // cy.visit('https://orisstage.research.unc.edu/irb/index.cfm?event=committee.reviewers&committeeId=2&reviewDate=08/07/2023');
    */
...
//describe('Test Committee View',  () => {
  it('Committee Reviewer Application pop up', () => {  
    ...
    cy.stub(win, 'open', url => {
        //win.location.href = 'https://orisstage.research.unc.edu/irb/index.cfm?event=admin.reviewWindow&reviewId=530098&appId=413332&committeeView=1';
        win.location.href = 'https://orisstage.research.unc.edu/irb/index.cfm?event=admin.reviewWindow&reviewId=530098&appId=413332&committeeView=1';
         }).as("popup")
    })
