describe('Create Full Form Study Application',  () => {
  it('Create Full Form', () => {
     ...
     //cy.visit('https://orisdev.research.unc.edu/irb_maint/eform_screens.cfm?MasterId=383421&ScreenId=80');
...
it('Accept Rely on Commerical For Review', () => {  
  ...
  cy.wait(1000)
  cy.get('#bucketDataTable_filter > label > input').type('My Full Form Cypress Test')
...
it('Verify Application/Review popup', () => {
  ...
  cy.get('td[data-title="Accepted By IRB"] > .bucket > :nth-child(2) > table > tbody > :nth-child(2) > [data-column="TBD"] > a').click().click()
  cy.wait(1000)
  cy.get('#bucketDataTable_filter > label > input').type('My Full Form Cypress Test')
  cy.get('#bucketDataTable > tbody > .odd > :nth-child(1) > a').click()
