...
describe('Login as Committee Member', () => {
  ...
  // cy.visit('https://orisdev.research.unc.edu/irb_maint/index.cfm?event=committee.reviewers&committeeId=2&reviewDate=08/07/2023');
    */
    ...
    cy.get('[data-href="https://research.unc.edu/wp-content/uploads/sites/61/2022/10/Document-38_IRB-Reviewer-Checklist-Initial-Application-8.15.2022.docx"] > .textLink').should('contain', 'Initial Application')
    cy.get('[data-href="https://research.unc.edu/wp-content/uploads/sites/61/2022/10/IRB-Reviewer-Checklist-Renewal-Application-11.14.2023.docx"] > .textLink').should('contain', 'Renewal')
    cy.get('[data-href="https://research.unc.edu/wp-content/uploads/sites/61/2022/10/Document-39_IRB-Reviewer_Checklist-Modifications-8.15.2022.docx"]').should('contain', 'Modification')
    cy.get('[data-href="https://research.unc.edu/wp-content/uploads/sites/61/2022/10/Document-37_IRB-Reviewer-Checklist-Additional-Considerations-8.15.2022.docx"] > .textLink').should('contain', 'Additional Considerations')
    cy.get('[data-href="https://research.unc.edu/wp-content/uploads/sites/61/2022/08/PRI-Worksheet.docx"] > .textLink').should('contain', 'PRI Reviewer Worksheet')
...
//describe('Test Committee View',  () => {
  it('Committee Reviewer Application pop up', () => {  
    ...
    cy.stub(win, 'open', url => {
        win.location.href = 'https://orisdev.research.unc.edu/irb_maint/index.cfm?event=admin.reviewWindow&reviewId=530098&appId=413332&committeeView=1';
         }).as("popup")
    })
